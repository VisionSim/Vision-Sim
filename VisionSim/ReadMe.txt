...
================================
Easy to use startup scripts are provided to simplify running Vision.
...
sim_console.sh       			: Start only the Vision standalone server
grid_console.sh      			: Start only the Vision grid server
...
run_standalonemode.sh       	: Run Vision standalone mode in background
run_gridmode.sh             	: Run Vision grid mode in background
...
===============================
The default configuration of Vision is setup to run in Standalone mode and
...
** Quick Customising **
=======================
You can quickly set a few options to customise your Vision installation.
...
Delete or backup the existing 'VisionSim/bin' subdirectory.
Extract the update package and copy the resulting 'bin' folder to your 'VisionSim' folder.
re-start..
